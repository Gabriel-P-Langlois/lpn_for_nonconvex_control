...
Migrated from legacy/old_notebooks/exp_4_1_2_quadratic_{2,4,8,16,32,64}D.ipynb (corrupted Moreau
target, finding 2) and the duplicate legacy/old_notebooks/exp_L1_prior_*.ipynb (same problem,
correct target). d=1 is legacy/old_notebooks/exp_4_2_1_1D.ipynb. The *_2D_MC notebook was a
